...
def test_remove_expense_reduces_total():
    ...
    expense1 = service.create_expense("Libro", 15, "", date.today())
    service.create_expense("Revista", 20, "", date.today())

    service.remove_expense(expense1.id)
...
def test_total_amount_after_removal():
    ...
    expense1 = service.create_expense("Cursos", 30, "", date.today())
