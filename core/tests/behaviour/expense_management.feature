Feature: Gestión de gastos
  ...
  Scenario: Crear tres gastos diferentes que sumen 30 euros hace que el total sean 30 euros
    ...
    And añado un gasto de 10 euros llamado Cubata
    And añado un gasto de 10 euros llamado Entrada
  ...
  Scenario: Crear tres gastos de 10, 30, 30 euros y elimino el ultimo gasto la suma son 40 euros
    Given un gestor de gastos vacío
    When añado un gasto de 10 euros llamado Desayuno
    And añado un gasto de 30 euros llamado Drogueria
  ...
  Scenario: Crear cuatro gastos de 5, 10, 30, 40 euros y elimino el tercer gasto la suma son 55 euros
    Given un gestor de gastos vacío
    When añado un gasto de 5 euros llamado Vasos
    And añado un gasto de 10 euros llamado Refrescos
    And añado un gasto de 30 euros llamado Mesas
    And añado un gasto de 40 euros llamado Regalo
    And elimino el gasto con id 3
    Then el total de dinero gastado debe ser 55 euros
  
  
  Scenario: Crear cuatro gastos de 5, 10, 30, 40 euros y elimino el segundo gasto la suma son 75 euros
    Given un gestor de gastos vacío
    When añado un gasto de 5 euros llamado Vasos
    And añado un gasto de 10 euros llamado Refrescos
    And añado un gasto de 30 euros llamado Mesas
    ...
    Then el total de dinero gastado debe ser 75 euros

  Scenario: Crear cuatro gastos de 5, 10, 30, 40 euros y elimino el primer gasto la suma son 80 euros
    Given un gestor de gastos vacío
    When añado un gasto de 5 euros llamado Vasos
    And añado un gasto de 10 euros llamado Refrescos
    And añado un gasto de 30 euros llamado Mesas
